...
best_f1_path = "model_best/VPFinder_att12_multi_f1.txt"
best_model_path = "model_best/VPFinder_att12_multi_model.pth"
...
class MultiClassifier(nn.Module):
    ...
    def forward(self, input_id, del_id, add_id, message_id, mask,
        ...
        att_avg = torch.mean(att_output_1[0], dim=1)  # [20, 768]

        res_output = patch_avg + att_avg  # [20, 768]

        input_1 = res_output

        att_output2 = self.att2(text, patch, patch)  # [20, 511, 768]
        input_2 = torch.mean(att_output2[0], dim=1)  # [20, 768]

        input = torch.cat((input_1, input_2), dim=1)  # [20 ,768 * 4]
