...
best_f1_path = "model_best/VPFinder_att2_multi_f1.txt"
best_model_path = "model_best/VPFinder_att2_multi_model.pth"
...
class MultiClassifier(nn.Module):
    ...
    def forward(self, input_id, del_id, add_id, message_id, mask,
        ...
        hidden_input = torch.cat((input_2, text_cls, patch_avg), dim=1)
