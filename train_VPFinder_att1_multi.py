...
best_f1_path = "model_best/VPFinder_att1_multi_f1.txt"
best_model_path = "model_best/VPFinder_att1_multi_model.pth"
...
class MultiClassifier(nn.Module):
    ...
    def forward(self, input_id, del_id, add_id, message_id, mask,
        ...
        patch = patch[:, 1:, :]  # [20, 511, 768]
        patch_avg = torch.mean(patch, dim=1)  # [20, 768]
        ...
        hidden_input = torch.cat((input_1, message_cls, patch_avg), dim=1)
