...
best_f1_path = "model_best/VPFinder_head4_multi_f1.txt"
best_model_path = "model_best/VPFinder_head4_multi_model.pth"
...
class MultiClassifier(nn.Module):
    def __init__(self):
        ...
        self.att1 = nn.MultiheadAttention(embed_dim=768, num_heads=4, batch_first=True)
        self.att2 = nn.MultiheadAttention(embed_dim=768, num_heads=4, batch_first=True)
