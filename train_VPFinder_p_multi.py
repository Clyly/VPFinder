...
best_f1_path = "model_best/VPFinder_p_multi_f1.txt"
best_model_path = "model_best/VPFinder_p_multi_model.pth"
...
class MultiClassifier(nn.Module):
    ...
    def forward(self, input_id, del_id, add_id, message_id, mask,
        ...
        input = torch.cat((add_patch[:, 0, :], del_patch[:, 0, :]), dim=1)  # [20 ,768 * 4]
